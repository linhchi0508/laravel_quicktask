        ...
        <div class="navbar-default sidebar row " role="navigation">
            <div class="sidebar-nav navbar-collapse col-2 menu">
                <ul class="nav flex-column mt-3 ml-5">
                    <li class="nav-item">
                        <a href="{{ route('student.index') }}"><i class="fa fa-dashboard fa-fw nav_icon"></i>{{ trans('homepage.homepage') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="{{ route('student.index') }}" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('student.index') }}">{{ trans('homepage.list_student') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('student.create') }}">{{ trans('homepage.creat_student') }}</a></li>

                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="{{ route('subject.index') }}" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa fa-table nav_icon"></i>{{ trans('homepage.subject') }}
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('subject.index') }}">{{ trans('homepage.list_subject') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('subject.create') }}">{{ trans('homepage.creat_subject') }}</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
