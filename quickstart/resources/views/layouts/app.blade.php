        ...
        <div class="navbar-default sidebar row " role="navigation">
            <div class="sidebar-nav navbar-collapse col-2 menu">
                <ul class="nav flex-column mt-3 ml-5">
                    <li class="nav-item">
                        <a href="#"><i class="fa fa-dashboard fa-fw nav_icon"></i>Home Page</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa fa-check-square-o nav_icon"></i>Student
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">List Student</a></li>
                            <li><a class="dropdown-item" href="#">Creat Student</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa fa-table nav_icon"></i>Subject
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">List Subject</a></li>
                            <li><a class="dropdown-item" href="#">Creat Subject</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
